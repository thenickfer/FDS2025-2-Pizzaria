...
public class DescontoService{
    ...
    public double calcularDesconto(Cliente c, double valor){
        ...
        List<Pedido> nroPedidos = pedidoRepository.ultimos20Dias(c.getId); // nao sei se vai ser getId ou getCPF, ver depois isso
